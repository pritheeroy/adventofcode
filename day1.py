...
def day1_part2(input_string):
    ...
    for line in lines:
        ...
        for i in range(len(line)):
            ...
            if match and (i==0 or match.start() == i):
                number_word = match.group().lower()
                numbers.append(key_mapping.get(number_word, number_word))
...
if __name__ == "__main__":
    input_string = """ckmb52fldxkseven3fkjgcbzmnr7
